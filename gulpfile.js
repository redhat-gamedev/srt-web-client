...
async function copyNetwork() {
    gulp.src(paths.network.src + '/**/*')
        .pipe(gulp.dest(paths.network.dest));
}
...
gulp.task('copy-network', copyNetwork);
gulp.task('copy-phaser', copyPhaser);
gulp.task('copy-styles', copyStyles);
gulp.task('copy-static', gulp.series('copy-html', 'copy-assets', 'copy-network', 'copy-phaser', 'copy-styles'));
